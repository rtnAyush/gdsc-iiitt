                ...
                <ul className="flex justify-center gap-5">
                    <li>
                        <a href="https://www.instagram.com/gdsc-iiitt/" target="_blank" rel="noopener noreferrer">
                            <svg className='hover:scale-125 duration-300 hover:text-pink-500' stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" height="2rem" width="2rem" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <a href="https://www.linkedin.com/company/gdsc-iiitt/" target="_blank" rel="noopener noreferrer">
                            <svg className='hover:scale-125 duration-300 hover:text-[#0a66c2]' stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" height="2rem" width="2rem" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <a href="https://twitter.com/gdsc_iiitt/" target="_blank" rel="noopener noreferrer">
                            {/* <svg className='hover:scale-125 duration-300 hover:text-blue-300' stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" height="2rem" width="2rem" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <a href="https://discord.gg/G2pC3EN34x" target="_blank" rel="noopener noreferrer">
                            <svg className='hover:scale-125 duration-300 hover:text-purple-400' stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 640 512" height="2rem" width="2rem" xmlns="http://www.w3.org/2000/svg">
